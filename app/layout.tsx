        ...
        <footer className="border-t border-white/5 py-12 bg-black/20 mt-auto">
          <div className="max-w-7xl mx-auto px-6 text-center text-stone-500 text-sm">
            ...
            <div className="flex justify-center gap-6 mt-4">
              ...
              <a href="https://github.com/Jdelg718/Everstone-btc/releases/tag/v1.0.0" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--accent-gold)] transition-colors flex items-center justify-center gap-2">
